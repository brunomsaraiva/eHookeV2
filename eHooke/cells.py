"""Module containing the classes needed for the computation of each
cell, their stats and the selection/filtering of the computed cells.
...
import eHooke.cellprocessing as cp
...
class CellManager(object):
    ...
    def process_cells(self, params, image_manager):
        ...
        for k in list(iter(self.cells.keys())):
            try:
