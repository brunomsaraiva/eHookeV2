...
from eHooke.main import EHooke
...
class Interface(object):
    ...
    def show_image(self, image):
        ...
        if image == "Base":
            ...
            self.ax.imshow(rescale_intensity(self.images[image][x1:x2, y1:y2]), cmap=cm.Greys_r)
        else:
            self.ax.imshow(rescale_intensity(self.images[image]), cmap=cm.Greys_r)
